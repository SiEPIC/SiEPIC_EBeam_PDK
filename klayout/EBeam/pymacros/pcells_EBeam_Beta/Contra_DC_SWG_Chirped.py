...
class Contra_DC_SWG_Chirped(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("grating_period_start", self.TypeDouble, "Grating period start (microns)", default = 0.24)
    self.param("grating_period_end", self.TypeDouble, "Grating period stop (microns)", default = 0.28)
