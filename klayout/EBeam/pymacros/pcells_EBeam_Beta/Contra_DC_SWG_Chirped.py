...
class Contra_DC_SWG_Chirped(pya.PCellDeclarationHelper):
    ...
    def display_text_impl(self):
        ...
        return "Contra_DC_SWG_chirped%s" % (self.number_of_periods)
    ...
    def produce_impl(self):
        ...
        box_final = Box(
            x + grating_period[i - 1],
            -half_w1,
            x + grating_period[i - 1] + box_width[i - 1],
            half_w1,
        )
        ...
        t = Trans(
            Trans.R0,
            to_itype(-box_width[0] / 2, dbu * 1000),
