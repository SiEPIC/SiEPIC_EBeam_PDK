...
class Contra_DC_dualBragg(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("number_of_periods", self.TypeInt, "Number of grating periods (sidewall)", default = 300)
    self.param("number_of_periods_swg", self.TypeInt, "Number of grating periods (sub-wavelength)", default = 260)
    self.param("grating_period1", self.TypeDouble, "Grating period (microns)", default = 0.318)
    self.param("grating_period2", self.TypeDouble, "Subwavelength Grating period (microns)", default = 0.420)
    ...
    self.param("corrugation_width", self.TypeDouble, "Subwavelength Corrugration width (microns)", default = 0.04)             
