...
files = [f for f in os.listdir(os.path.join(os.path.dirname(os.path.realpath(__file__)),'pcells_EBeam_Dream')) if '.py' in pathlib.Path(f).suffixes  and '__init__' not in f]
